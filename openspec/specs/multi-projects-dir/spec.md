...
Defines requirements for indexing Claude sessions from multiple projects directories, enabling users to aggregate sessions from separate Claude environments (e.g., personal, work, Bedrock) into a single database with per-environment filtering.
